...
public class RootConfig {
    ...
    public DataSource getDataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/orion?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Asia/Yakutsk");
